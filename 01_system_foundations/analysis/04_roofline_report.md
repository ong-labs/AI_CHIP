...
### 핵심 3. Arithmetic Intensity (AI)의 중요성

AI는 시스템 병목을 진단하는 핵심 지표입니다.

* **정의**: $AI=\frac{FLOPs}{Bytes}$ (데이터 1바이트당 얼마나 많은 연산을 수행하는가)
* **결론**: AI가 **높을수록** 메모리 전송보다 연산이 주를 이루어 **Compute-bound** 영역에 들어가기 쉬우며, 이는 곧 **GPU의 효율이 극대화됨**을 의미합니다. 행렬곱은 태생적으로 AI가 매우 높은 연산입니다.
